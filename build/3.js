...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ElectionCandidatesPageModule", function() { return ElectionCandidatesPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__election_candidates__ = __webpack_require__(305);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_candidate_candidate__ = __webpack_require__(302);
...
var ElectionCandidatesPageModule = (function () {
    function ElectionCandidatesPageModule() {
    }
    ElectionCandidatesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__election_candidates__["a" /* ElectionCandidatesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__election_candidates__["a" /* ElectionCandidatesPage */]),
                __WEBPACK_IMPORTED_MODULE_2_ionic_cache__["a" /* CacheModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_3__pipes_pipes_module__["a" /* PipesModule */]
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_5__providers_candidate_candidate__["a" /* CandidateProvider */]
            ]
        })
    ], ElectionCandidatesPageModule);
    return ElectionCandidatesPageModule;
}());

//# sourceMappingURL=election-candidates.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CandidateProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var CandidateProvider = (function () {
    /**
     * Initialize
     */
    function CandidateProvider(http, base, ionStorage, events, cache) {
        this.http = http;
        this.base = base;
     ...
     * Cache Settings
     */
    CandidateProvider.prototype.initCacheSettings = function () {
     ...
     * Clear Cached Data
     */
    CandidateProvider.prototype.clearCachedElections = function () {
        this.cache.clearGroup(this.cacheGroupKey);
    };
    /**
     * Get Candidates
     */
    CandidateProvider.prototype.getCandidates = function () {
        return [
            {
                "id": "001",
                "name": "Satydev Mishra",
            ...
            },
            {
                ...
                "gender": "male",
                "age": "28",
                "qualification": "Persuing B.E. (C.Tech) Final Year",
                "about": "The nuance of interviewing extends well beyond skills and abilities into areas of candidate maturity level, culture fit and self-awareness to assess overall candidate quality. You can mitigate some of these questions for fit if you’re attracting informed candidates who have engaged with your employer brand through Glassdoor’s recruiting soltuion. Tools like Glassdoor help showcase the different areas of your culture to better attract candidates that are a fit and want to drink your company’s Kool-Aid...",
                "mantra": "Vote for me... Vote for change.."
            },
            {
     ...
     * Add Vote
     */
    CandidateProvider.prototype.addVote = function (data) {
        var url = 'http://localhost:3001/transaction';
        return this.http.post(url, data).map(function (res) { return res.json(); });
    };
    CandidateProvider = __decorate([
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ElectionCandidatesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_base_settings_storage__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_candidate_candidate__ = __webpack_require__(302);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ElectionCandidatesPage = (function () {
    /**
     * Constructor
     */
    function ElectionCandidatesPage(navCtrl, navParams, menuCtrl, modalCtrl, loadingCtrl, toastCtrl, ionStorage, actionSheetCtrl, alertCtrl, candidateProv) {
        ...
        this.candidateProv = candidateProv;
        this.sessionToken = '';
        ...
        env.getElectionCandidates();
    }
    /**
     * When control enters Ionic View
     */
    ElectionCandidatesPage.prototype.ionViewDidEnter = function () {
        var env = this;
        // Enabling the menu
     ...
     * Check User Session
     */
    ElectionCandidatesPage.prototype.checkUserSession = function () {
        var _this = this;
        var env = this;
     ...
     */
    ElectionCandidatesPage.prototype.getElectionCandidates = function () {
        var env = this;
        env.candidates = env.candidateProv.getCandidates();
    };
    /**
     * Go to Candidates Listing for this election
     */
    ElectionCandidatesPage.prototype.gotoCandidatesListing = function () {
        this.navCtrl.push('ElectionCandidatesPage');
    };
    /**
     * Show Vote actions
     */
    ElectionCandidatesPage.prototype.showVoteActions = function (candidate) {
        var _this = this;
        var actionSheet = this.actionSheetCtrl.create({
            title: "Click the vote now button to vote for : " + candidate.name,
            buttons: [
                {
                    text: 'Vote Now',
                    role: 'destructive',
                    handler: function () {
                        var loading = _this.loadingCtrl.create({
                            content: 'Please wait while we register your vote...'
                        });
                        loading.present();
                        var params = {
                            amount: 1,
                            sender: _this.sessionUser.name + "-" + _this.sessionUser.username,
                            recipient: candidate.name
                        };
                        console.log(params);
                        _this.candidateProv.addVote(params).subscribe(function (data) {
                            console.log(data);
                            loading.dismiss();
                            var alert = _this.alertCtrl.create({
                                title: 'Success',
                                subTitle: 'Successfully voted.',
                                buttons: ['Done']
                            });
                        }, function (err) {
                            loading.dismiss();
                            var alert = _this.alertCtrl.create({
                                title: 'Failure',
                                subTitle: 'Unable to cast a vote at the moment. Please try again later.',
                                buttons: ['Dismiss']
                            });
                            alert.present();
                        });
     ...
     * Logout
     */
    ElectionCandidatesPage.prototype.logout = function () {
        this.ionStorage.removeItem('sessionuser');
        this.navCtrl.setRoot('LoginPage');
    };
    ElectionCandidatesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-election-candidates',template:/*ion-inline-start:"/private/var/www/html/aadityas/projects/blockchain/app/src/pages/election-candidates/election-candidates.html"*/'<!-- Header -->\n<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n\n    <ion-title>General Election</ion-title>\n\n    <ion-buttons end>\n      <button ion-button (click)="logout()">\n        <ion-icon name="power"></ion-icon>\n      </button>\n		</ion-buttons>\n  </ion-navbar>\n</ion-header>\n<!-- Header -->\n\n<!-- Content -->\n<ion-content>\n  <ion-list>\n    <ion-item *ngFor="let candidate of candidates" (click)="showVoteActions(candidate)">\n      <ion-thumbnail item-start>\n        <img src="assets/candidates/{{ candidate.id }}.jpeg">\n      </ion-thumbnail>\n      <h2 class="font-20">{{ candidate.name }}</h2>\n      <h4>{{ candidate.mantra }}</h4>\n      <p>{{ candidate.gender +" - "+ candidate.age + \' years old\' }}</p>\n      <p>{{ candidate.qualification }}</p>\n      <p>{{ candidate.about }}</p>\n    </ion-item>\n  </ion-list>\n</ion-content>\n<!-- Content -->\n'/*ion-inline-end:"/private/var/www/html/aadityas/projects/blockchain/app/src/pages/election-candidates/election-candidates.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_3__providers_candidate_candidate__["a" /* CandidateProvider */]])
    ], ElectionCandidatesPage);
    return ElectionCandidatesPage;
}());

//# sourceMappingURL=election-candidates.js.map
