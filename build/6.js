...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login__ = __webpack_require__(309);
...
var LoginPage = (function () {
     ...
     * Constructor Method
     */
    function LoginPage(navCtrl, navParams, formBuilder, loadingCtrl, toastCtrl, userProvider, ionStorage, event) {
            ...
            if (data && data != null) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (user.username == formdata.username && user.password == formdata.password) {
                        _this.ionStorage.setItem('sessionuser', user);
                        _this.gotoDashboardPage();
                        break;
                    }
                }
            }
     ...
     */
    LoginPage.prototype.gotoDashboardPage = function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/private/var/www/html/aadityas/projects/blockchain/app/src/pages/login/login.html"*/'<ion-content class="card-background-page">\n  <h2 class="title" text-center>DemoCratic</h2>\n  <h3 class="title-subremark" text-center>We make democracy untampered</h3>\n\n  <ion-thumbnail>\n    <img src="assets/imgs/logo.png" class="logo">\n  </ion-thumbnail>\n\n  <form [formGroup]="loginForm" (ngSubmit)="login()" class="login-form">\n    <ion-list>\n      <ion-item>\n        <ion-label stacked>Mobile No</ion-label>\n        <ion-input type="tel" formControlName="username"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-label stacked>Password</ion-label>\n        <ion-input type="password" formControlName="password"></ion-input>\n      </ion-item>\n    </ion-list>\n\n    <div padding>\n      <button ion-button type="submit" color="primary" block [disabled]="!loginForm.valid">\n        Sign In\n      </button>\n    </div>\n\n    <div text-center>\n      <p>Do not have an account - <a class="registration-link" (click)="gotoRegistrationPage()">Create Account</a></p>\n    </div>\n  </form>\n</ion-content>\n'/*ion-inline-end:"/private/var/www/html/aadityas/projects/blockchain/app/src/pages/login/login.html"*/
        }),
