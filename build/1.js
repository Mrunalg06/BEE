...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ElectionsPageModule", function() { return ElectionsPageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__elections__ = __webpack_require__(307);
...
var ElectionsPageModule = (function () {
    function ElectionsPageModule() {
    }
    ElectionsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__elections__["a" /* ElectionsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__elections__["a" /* ElectionsPage */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ElectionsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(100);
...
var ElectionsPage = (function () {
    /**
     * Constructor
     */
    function ElectionsPage(navCtrl, navParams, menuCtrl, modalCtrl, loadingCtrl, toastCtrl, ionStorage, actionSheetCtrl, alertCtrl, electionProv) {
     ...
     */
    ElectionsPage.prototype.ionViewDidEnter = function () {
        var env = this;
        // Enabling the menu
     ...
     * Check User Session
     */
    ElectionsPage.prototype.checkUserSession = function () {
        var _this = this;
        var env = this;
     ...
     */
    ElectionsPage.prototype.clearSearchFilter = function () {
     ...
     */
    ElectionsPage.prototype.doInfinite = function (infiniteScroll) {
        if (this.electionsList.length >= 20) {
            // If next offset is not false, load the next list
            if (this.next_offset) {
                this.filterAndSearchElections(this.next_offset, false, false, infiniteScroll);
            }
     ...
     */
    ElectionsPage.prototype.forceReload = function (refresher) {
        var env = this;
        env.filterAndSearchElections('0', true, true);
        refresher.complete();
    };
    /**
     * Search Filter for Name
     */
    ElectionsPage.prototype.searchElectiosByName = function (ev, type) {
        var searchterm = ev.target.value;
        this.searchFilterBasic.name = searchterm;
        this.filterAndSearchElections('0', true, true);
    };
    /**
     * Search By Modal Filters
     */
    ElectionsPage.prototype.searchByModalFilters = function (name, phone_mobile, cities, expected_sales, sources, statuses) {
        // Clear Search Filter
     ...
     */
    ElectionsPage.prototype.filterAndSearchElections = function (offset, refresh, showLoader, infiniteScroll) {
        var query = "";
        ...
        if (typeof (this.searchFilterBasic.name) != 'undefined' && this.searchFilterBasic.name != '') {
            queryImploderArr['name'] = "(CONCAT(elections.first_name, ' ', elections.last_name) LIKE '%" + this.searchFilterBasic.name + "%')";
        }
        ...
        if (typeof (this.searchFilterBasic.phone_mobile) != 'undefined' && this.searchFilterBasic.phone_mobile != '' && this.searchFilterBasic.phone_mobile.length == 10) {
            queryImploderArr['phone'] = "(elections.phone_mobile LIKE '" + this.searchFilterBasic.phone_mobile + "%')";
        }
        // Electio Cities
        ...
        if (this.searchFilterBasic.cities.length > 0) {
            ...
            for (var city in this.searchFilterBasic.cities) {
                var temp = "elections.primary_address_city = '" + this.searchFilterBasic.cities[city] + "'";
        ...
        if (this.searchFilterBasic.sources.length > 0) {
            ...
            for (var source in this.searchFilterBasic.sources) {
                var temp = "elections.lead_source = '" + this.searchFilterBasic.sources[source] + "'";
        ...
        if (typeof (this.searchFilterBasic.expected_sales) != 'undefined' && this.searchFilterBasic.expected_sales != '') {
            queryImploderArr['expectedsales'] = "(elections_cstm.expected_sales_c = '" + this.searchFilterBasic.expected_sales + "')";
        }
        // Statuses
        ...
        if (this.searchFilterBasic.statuses.length > 0) {
            ...
            for (var status_1 in this.searchFilterBasic.statuses) {
                var temp = "elections.status = '" + this.searchFilterBasic.statuses[status_1] + "'";
        ...
        // Call Method to Retrieve elections list
        this.getElectionsList(query, offset, refresh, showLoader, infiniteScroll);
    };
    /**
     * Get Electios Listing
     */
    ElectionsPage.prototype.getElectionsList = function (query, offset, refresh, showLoader, infiniteScroll) {
        var env = this;
        // First Loader Start
        var loader;
        if (showLoader) {
        ...
        // Set default query for hide closed and won elections from listing by default
        query = (query == "") ? "(elections.status != 'closed_lost' AND elections.status != 'closed_won')" : query;
        query = (query != '') ? query + " AND " : "";
        query = query + "(elections.assigned_user_id = '" + env.sessionUser.id + "')";
        // Fetch Params
        var params = {
            'offset': offset,
            'query': query,
     ...
     */
    ElectionsPage.prototype.getElections = function () {
        var env = this;
        env.electionsList = env.electionProv.getElections();
    };
    /**
     * Go to Electio Details Page
     */
    ElectionsPage.prototype.gotoElectionDetails = function (election_id) {
        this.navCtrl.push('ElectionDetailsPage', { election_id: election_id });
    };
    /**
     * Logout
     */
    ElectionsPage.prototype.logout = function () {
        this.ionStorage.removeItem('sessionuser');
        this.navCtrl.setRoot('LoginPage');
    };
    ElectionsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-elections-list',template:/*ion-inline-start:"/private/var/www/html/aadityas/projects/blockchain/app/src/pages/elections/elections.html"*/'<!-- Header -->\n<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n\n    <ion-title>Elections</ion-title>\n\n    <ion-buttons end>\n      <button ion-button (click)="logout()">\n        <ion-icon name="power"></ion-icon>\n      </button>\n		</ion-buttons>\n  </ion-navbar>\n</ion-header>\n<!-- Header -->\n\n<!-- Content -->\n<ion-content>\n  <!-- Refresher -->\n  <ion-refresher (ionRefresh)="forceReload($event)">\n    <ion-refresher-content pullingIcon="arrow-dropdown"></ion-refresher-content>\n  </ion-refresher>\n  <!-- Refresher -->\n\n  <!-- List -->\n  <div *ngIf="electionsList.length > 0">\n    <ion-list *ngFor="let dateItem of electionsList; let i = index">\n      <ion-list-header>{{ dateItem.name }}</ion-list-header>\n\n      <ion-item tappable *ngFor="let item of dateItem.elections" (click)="gotoElectionDetails(\'001\')">\n        <ion-avatar item-start>\n          <img src="{{ default_image }}">\n        </ion-avatar>\n        <h2 class="font-17 capitalize" [innerHtml]="item.name"></h2>\n        <p class="font-15 capitalize" [innerHtml]="item.name_full"></p>\n        <p class="capitalize" [innerHtml]="item.candidates + \' Candidates\'"></p>\n        <ion-note item-end class="status {{ item.status }} capitalize" [innerHtml]="item.status"></ion-note>\n      </ion-item>\n    </ion-list>\n  </div>\n  <!-- List -->\n\n  <!-- Empty List -->\n  <ion-list *ngIf="electionsList.length == 0" class="no-results-list">\n    <ion-item text-center>\n      <ion-avatar>\n        <img src="{{ default_image }}" item-center style="margin: auto;">\n      </ion-avatar>\n      <p class="no-results-text">No Results</p>\n      <p>Pull down to refresh</p>\n    </ion-item>\n  </ion-list>\n  <!-- Empty List -->\n\n  <!-- Infinite Scroll -->\n  <ion-infinite-scroll (ionInfinite)="doInfinite($event)">\n    <ion-infinite-scroll-content loadingSpinner="bubbles"\n      loadingText="Loading more data..."></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n  <!-- Infinite Scroll -->\n</ion-content>\n<!-- Content -->\n'/*ion-inline-end:"/private/var/www/html/aadityas/projects/blockchain/app/src/pages/elections/elections.html"*/
        }),
